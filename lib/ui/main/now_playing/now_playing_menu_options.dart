...
List<ContextMenuOption> getNowPlayingMenuOptions(
  ...
  ContextMenuOption(
    ...
    onSelected: () {
      ...
      Toast.show(context, "Added '${viewModel.songTitle}' to priority queue");
    },
  ...
  ContextMenuOption(
    title: viewModel.favorite ? "Remove from favorites" : "Add to favorites",
    onSelected: () {
  ...
  ContextMenuOption(
    ...
    onSelected: () {
      ...
      if (panelController?.isAttached ?? false) {
