...
class SearchBloc extends Bloc<SearchEvent, SearchState> {
  ...
  SearchBloc(this._subsonicRepository)
  ...
  Future<List<SearchResult>> _fetchSongs() async {
    final (_, _, songs) = await _subsonicRepository.search3(_text,
  ...
  Future<List<SearchResult>> _fetchAlbums() async {
    final (_, albums, _) = await _subsonicRepository.search3(_text,
  ...
  Future<List<SearchResult>> _fetchArtists() async {
    final (artists, _, _) = await _subsonicRepository.search3(_text,
