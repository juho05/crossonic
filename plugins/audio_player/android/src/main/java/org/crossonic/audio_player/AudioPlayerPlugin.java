...
public class AudioPlayerPlugin implements FlutterPlugin, ActivityAware {
    private static final String METHOD_CHANNEL = "org.crossonic.audio_player.method";
    private static final String EVENT_CHANNEL = "org.crossonic.audio_player.event";
