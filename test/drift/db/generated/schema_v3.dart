...
class PlaylistSong extends Table
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [playlistId, index, songId, childModelJson];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {playlistId, index};
  @override
...
class PlaylistSongData extends DataClass
  ...
  @override
  int get hashCode => Object.hash(playlistId, index, songId, childModelJson);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
